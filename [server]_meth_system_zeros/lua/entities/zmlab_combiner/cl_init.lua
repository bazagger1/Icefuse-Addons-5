...
File Path:   addons/[server]_meth_system_zeros/lua/entities/zmlab_combiner/cl_init.lua
...
function ENT:DrawInfo()
	local Pos = self:GetAttachment(self:LookupAttachment("screen")).Pos
	local Ang = self:GetAttachment(self:LookupAttachment("screen")).Ang
	...
	if (cleanProcess > 0) then
		...
		--draw.DrawText("CleaningProgress", "zmlab_font1", 0, 25,  Color(255,255,255,255), TEXT_ALIGN_CENTER )
	end
